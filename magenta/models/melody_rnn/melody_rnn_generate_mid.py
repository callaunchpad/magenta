...
def run_with_flags(generator):
  ...
  for i in range(FLAGS.num_outputs):
    ...
    # flag2 = "C:\\DATA\\Daniel\\Desktop\\tet"
    # midi_path = os.path.join(flag2, midi_filename)
    midi_path = os.path.join(FLAGS.output_dir, midi_filename)
    # print(generated_sequence)
    # print(type(generated_sequence))
    # print(repr(generated_sequence))
    pretty_midi_object = magenta.music.sequence_proto_to_pretty_midi(
      generated_sequence, None)
    pretty_midi_object.write(midi_path)
