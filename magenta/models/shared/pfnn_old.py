...
class PhaseFunctionedLSTM(BasicLSTMCell):
    ...
    def __call__(self, inputs, state):
        ...
        for layer in self.layers:
            interpolated = self.cubic_spline(layer[k(0)], layer[k(1)], layer[k(2)], layer[k(3)], w)
...
class PhaseAttentionCellWrapper(AttentionCellWrapper):
    ...
    def call(self, inputs, state):
        ...
        inputs = np.hstack((inputs, self.phase))
...
class PhaseDropoutWrapper(DropoutWrapper):
    ...
    def __init__(self, cell, input_keep_prob=1.0, output_keep_prob=1.0,
        ...
        super().__init__(cell, input_keep_prob, output_keep_prob=output_keep_prob, state_keep_prob=state_keep_prob, 
